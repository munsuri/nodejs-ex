...
module.importSync("meteor/tmeasday:check-npm-versions", {                                         // 1
...
var MeteorDataManager = function () {                                                             //
  ...
  return MeteorDataManager;                                                                       //
                                                                                                  ...
                                                                                                  //
module.export("default", exports.default = ReactMeteorData);                                      // 1
////////////////////////////////////////////////////////////////////////////////////////////////////
...
module.importSync("react-addons-pure-render-mixin", {                                             // 1
  "default": function (v) {                                                                       // 1
    PureRenderMixin = v;                                                                          // 1
  }                                                                                               // 1
}, 1);                                                                                            // 1
var ReactMeteorData = void 0;                                                                     // 1
module.importSync("./ReactMeteorData.jsx", {                                                      // 1
  "default": function (v) {                                                                       // 1
    ReactMeteorData = v;                                                                          // 1
  }                                                                                               // 1
}, 2);                                                                                            // 1
